...
describe('AMM', () => {
  ...
  describe('Swapping tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      console.log(`Token2 amount investor1 will receive after swapt: ${ethers.utils.formatEther(estimate)}\n`)
      ...
      balance = await token2.balanceOf(investor1.address)
      console.log(`Invest1 Token2 balance after swap: ${ethers.utils.formatEther(balance)}\n`)
      ...
      // Check LP balance before rmoving tokens
